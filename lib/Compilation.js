...
BREAKING CHANGE: Asset processing hooks in Compilation has been merged into a single Compilation.hooks.processAssets hook.`;
		...
		// @READ: addModuleTree -> handleModuleCreation -> factorizeQueue -> addModuleQueue -> buildQueue[normalModule build] -> processDependenciesQueue -> handleModuleCreation
			...
			(err, factoryResult) => {
				...
				this.addModule(newModule, (err, _module) => {
					...
					if (
						...
						// @READ 根据 AST 拿到的 dependencies，构建 ModuleGraph
